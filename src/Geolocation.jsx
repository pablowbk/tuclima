  ...
  return (
    <form class="Geolocation" onSubmit={getUserLocation}>
      ...
      <button class="getLocation-btn" type="submit">
        <svg class="location-icon" viewBox="0 0 485 485" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle class="inner-circle" cx="242.5" cy="242.5" r="64.1261" fill="#fff"/>
          <path class="outer-circle" fill-rule="evenodd" clip-rule="evenodd"
